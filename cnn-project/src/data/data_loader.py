...
DATASET_ROOT = Path(__file__).resolve().parents[3] / 'data' / 'DATASET' / 'classification' / 'Training'
TEST_ROOT    = Path(__file__).resolve().parents[3] / 'data' / 'DATASET' / 'classification' / 'Testing'
